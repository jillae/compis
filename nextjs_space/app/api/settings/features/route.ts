...
export async function GET(request: NextRequest) {
  try {
    ...
    const features = {
      ...
      corexRemindersEnabled: user.clinic.corexRemindersEnabled,
      corexReminderTonality: user.clinic.corexReminderTonality,
      corexReminderTemplate: user.clinic.corexReminderTemplate,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      ...
      corexReminderTonality,
      corexReminderTemplate,
    ...
    const updatedClinic = await prisma.clinic.update({
      ...
      data: {
        ...
        corexRemindersEnabled: corexRemindersEnabled ?? user.clinic.corexRemindersEnabled,
        corexReminderTonality: corexReminderTonality ?? user.clinic.corexReminderTonality,
        corexReminderTemplate: corexReminderTemplate ?? user.clinic.corexReminderTemplate,
    ...
    return NextResponse.json({
      ...
      features: {
        ...
        corexRemindersEnabled: updatedClinic.corexRemindersEnabled,
        corexReminderTonality: updatedClinic.corexReminderTonality,
        corexReminderTemplate: updatedClinic.corexReminderTemplate,
